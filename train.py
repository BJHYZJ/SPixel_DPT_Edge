...
parser.add_argument('--weight_decay', default=4e-4, type=float, metavar='W', help='weight decay')
...
def validate(val_loader, model, epoch, val_writer, init_spixl_map_idx, xy_feat):
    ...
    logger.info('total_loss_avg: {}\tlosses_sem_avg: {}\tlosses_pos_avg: {}'.format(total_loss.avg, losses_sem.avg, losses_pos.avg))
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        logger.info("epoch spend time is".format(endTime))
